...
pub struct WasmMockQuerier {
    ...
    routerswap_factory_querier: RouterswapFactoryQuerier,
}
...
impl WasmMockQuerier {
    pub fn new(base: MockQuerier) -> Self {
        WasmMockQuerier {
            ...
            routerswap_factory_querier: RouterswapFactoryQuerier::default(),
        }
    }
    ...
    // configure the routerswap pair
    pub fn with_routerswap_factory(
        &mut self,
        pairs: &[(&String, &PairInfo)],
        native_token_decimals: &[(String, u8)],
    ) {
        self.routerswap_factory_querier =
            RouterswapFactoryQuerier::new(pairs, native_token_decimals);
    }
