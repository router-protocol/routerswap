# Routerswap: Common Types

This is a collection of common types and the queriers which are commonly used in routerswap contracts.
...
It also provides the query interface to query avaliable routerswap pair contract info. Any contract can query pair info to routerswap factory contract.
...
It also provides the query interface to query avaliable routerswap pair contract info. Any contract can query pair info to pair contract.
