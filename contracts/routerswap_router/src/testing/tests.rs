...
use routerswap::mock_querier::mock_dependencies;

use cw20::{Cw20ExecuteMsg, Cw20ReceiveMsg};
use routerswap::asset::{Asset, AssetInfo, PairInfo};
use routerswap::pair::ExecuteMsg as PairExecuteMsg;
...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        routerswap_factory: "routerswapfactory".to_string(),
    };
    ...
    assert_eq!("routerswapfactory", config.routerswap_factory.as_str());
}
        ...
        vec![
            SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
                ...
                msg: to_binary(&ExecuteMsg::ExecuteSwapOperation {
                    operation: SwapOperation::RouterSwap {
                        offer_asset_info: AssetInfo::NativeToken {
                            denom: "ukrw".to_string(),
                        },
                        ask_asset_info: AssetInfo::Token {
...
fn execute_swap_operation() {
    ...
    deps.querier.with_routerswap_factory(
        &[(
...
fn query_reverse_routes_with_from_native() {
    ...
    let msg = QueryMsg::ReverseSimulateSwapOperations {
        ...
        operations: vec![SwapOperation::RouterSwap {
            offer_asset_info: AssetInfo::NativeToken {
                denom: "ukrw".to_string(),
            },
            ask_asset_info: AssetInfo::Token {
