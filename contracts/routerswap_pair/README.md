...
This is mainly used from routerswap factory contract to create new routerswap pair. It initialize all swap created parameters which can be updated later with owner key.
