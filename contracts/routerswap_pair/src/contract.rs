...
use routerswap::asset::{Asset, AssetInfo, PairInfo, PairInfoRaw};
use routerswap::pair::{
    Cw20HookMsg, ExecuteMsg, InstantiateMsg, MigrateMsg, PoolResponse, QueryMsg,
    ReverseSimulationResponse, SimulationResponse,
};
use routerswap::querier::query_token_info;
use routerswap::token::InstantiateMsg as TokenInstantiateMsg;
use std::cmp::Ordering;
use std::str::FromStr;

// version info for migration info
const CONTRACT_NAME: &str = "crates.io:routerswap-pair";
...
/// we compute new spread else we just use routerswap
